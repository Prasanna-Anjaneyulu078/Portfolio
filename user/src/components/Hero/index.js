...
const Hero = ({ userData = {}, educationData = {}, codingProfiles = [] }) => {
  const handleDownloadResume = async () => {
    try {
      ...
      const fileName = `${userData.name || 'User'}_Resume.pdf`;
      ...
      alert("Could not download resume. Please ensure an active resume is uploaded in the Admin panel.");
    }
  };
      ...
      <div className="container">
        <div className="home-grid">
          <div className="home-content">
            ...
            <h1 className="home-title">{userData.name || "Prasanna Anjaneyulu"}</h1>
            <h2 className="home-subtitle">
              {userData.role || "Software Engineer | Full Stack Developer"}
            </h2>

            {userData.bio && (
              <p className="home-intro">{userData.bio}</p>
            )}
            ...
            {/* Social Links: GitHub / LinkedIn / LeetCode / Gmail */}
