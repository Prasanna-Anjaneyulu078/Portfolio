...
const ResumeSection = () => {
  ...
  const downloadResume = (resume) => {
    ...
    link.href = getPdfUrl(resume.url);
  ...
  if (isLoading) {
    return (
      <div className="loading-container" role="status" aria-label="Loading resume manager">
        <div className="loading-spinner"></div>
        <p className="loading-text">Loading Resume Manager...</p>
      </div>
    );
  }
  ...
  return (
    <section className="section-container" id="resume">
          ...
          <div className="active-resume-banner">
            <div className="banner-content">
              ...
              <div className="banner-actions">
                {activeResume && (
                  <>
                    <button className="btn-banner-action" onClick={() => handleViewPdf(activeResume)}>
                ...
                resumes.map(resume => (
                  <div key={resume._id} className={`resume-row ${resume.isActive ? 'is-active' : ''}`}>
                    ...
                    <div className="row-actions">
                      <button className="action-btn view-btn" onClick={() => handleViewPdf(resume)} title="View PDF">
                        <span className="material-symbols-outlined">visibility</span>
                      </button>
      ...
      {/* In-App Native Resume Viewer Modal */}
      {viewingPdf && (
          ...
          <div className="pdf-modal-container" onClick={(e) => e.stopPropagation()}>
            <div className="pdf-modal-header">
              <div className="pdf-modal-title">
                ...
                <h3>{viewingPdf.fileName}</h3>
              </div>
              <div className="pdf-modal-actions">
                <button className="btn-banner-action" onClick={() => downloadResume(viewingPdf.rawResume)}>
                  <span className="material-symbols-outlined">download</span>
                  Download
                </button>
                <button className="pdf-close-btn" onClick={() => setViewingPdf(null)} title="Close Viewer">
